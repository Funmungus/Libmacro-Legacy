...
MCR_API int mcr_safe_string_deinitialize(struct mcr_context *ctx);
/* TODO: Start with size 0xFF, add trim function */
MCR_API int mcr_signal_extras_initialize(struct mcr_context *ctx);
MCR_API int mcr_signal_extras_deinitialize(struct mcr_context *ctx);
...
MCR_API int mcr_extras_native_deinitialize(struct mcr_context *ctx);
