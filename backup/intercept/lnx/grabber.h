/*! \file hotkey/grabber.h
 * \brief Grabber, Take exclusive access to a /dev/input event.
 * TODO Integrate grab_devices file with config file.
 */

# ifndef MCR_GRABBER_H
# define MCR_GRABBER_H
...
namespace macro
{
	...
	public :
		...
		void keyState ( unsigned char * buffer, const unsigned int size ) const ;
	private :
		LnxFileSafety _fs ;
		bool _enable ;
	} ;
